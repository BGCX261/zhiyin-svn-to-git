...
<div id="overlay-container-1" class="overlay" style="display:none ">
	<div id="content-settings-page" class="page" style="max-height: 800px">
		...
		<h1>选择客户</h1>
		<div class="content-area loading" id="customer-select-box" style="min-height:400px;">
		</div>		
...
$(document).ready(function(){ 
	...
	$("#sel_customer").click(function() {
		$("#customer-select-box").addClass("loading");
		$("#customer-select-box").load('/baseinfo/customers/queryByAjaxHtml', {},function(){$("#customer-select-box").removeClass("loading");});	
		$("#overlay-container-1").show();		
	});
		
});

function sel_customer(id,name){
