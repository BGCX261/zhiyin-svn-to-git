...
<form class="form-horizontal" id="J_Auth" method="post" action="/baseinfo/products/edit">
	<input type="hidden" name="id" value="<?php echo $product['id']?>">
    <div class="control-group">
        <label class="control-label" for="name">印件名称</label>
        <div class="controls">
            <input type="text" class="input-xlarge" name="name" id="name" value="<?php echo $product['name']?>" required>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="input-xlarge" name="guige" id="guige" value="<?php echo $product['guige']?>">
        </div>
    </div>  
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="input-xlarge" name="note" id="note" value="<?php echo $product['note']?>">            
        </div>
    </div>  
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	...
        	<?php if(count($needMaterials)){        	
        		foreach ($needMaterials as $k => $v){
					echo "<div id=\"selected-material-item-".$v['material_id']."\" data-id=\"".$v['material_id']."\" class=\"selected-material-item\">";
					echo "<span>".$v['name']."</span>";
					echo "<input type=\"text\" class=\"input-small\" name=\"materials[".$v['material_id']."]\" id=\"material-num-".$v['material_id']."\" value=\"".$v['need_materials']."\"required number=\"true\">";
					echo "<a href=\"#\" onclick=\"delMaterial(".$v['material_id'].");\" class=\"material-del\" data-materialId=\"".$v['material_id']."\" title=\"删除\"></a>";
					echo "</div>";
				}
        	}?>
...
$(document).ready(function(){ 	
	//设置选中
	 $(".selected-material-item").each(function(){
			$("#material_"+$(this).data('id')).addClass("selected");
			$("#material_"+$(this).data('id')).data('selected',1);		    
     });
